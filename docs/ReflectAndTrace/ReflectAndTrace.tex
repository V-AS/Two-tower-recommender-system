...
\begin{enumerate}
    ...
    \item \href{https://github.com/V-AS/Two-tower-recommender-system/issues/25}{Issue 25}: Use a curved line for the image in Section 9 of the MG.
    
    
    \href{https://github.com/V-AS/Two-tower-recommender-system/commit/98fbbcbdf7dcf375f0bd901935588a59fef742eb}{Commit 98fbbcb}: Updated the use hierarchy image, no lines cross other module boxes. Removed the line from the Model Training Module to the Vector Operations Module, as it was incorrect.
