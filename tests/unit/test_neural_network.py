...
from src.modules.neural_network import TowerNetwork, create_user_tower, create_item_tower
...
class TestNeuralNetwork(unittest.TestCase):
    ...
    def test_create_user_tower(self):
        ...
        user_tower = create_user_tower(
            ...
            hidden_layers=[128, 64],  # These should be ignored in the simplified version
