...
Tests data loading, validation, preprocessing, and training data creation.
"""
import sys
import os
import unittest
...
class TestDataProcessor(unittest.TestCase):
    ...
    def test_split_data(self):
        ...
        # Split data
        train_data, test_data = self.data_processor.split_data(self.sample_data, train_ratio=0.6)
        ...
        self.assertAlmostEqual(len(test_data), len(self.sample_data) - expected_train_size, delta=1)
    ...
    def test_create_training_data(self):
        ...
        expected_keys = ['user_ids', 'item_ids', 'ratings', 'user_features', 'item_features']
